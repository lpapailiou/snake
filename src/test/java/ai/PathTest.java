...
public class PathTest {
    ...
    public void pathConversionTest2() {
        ...
        List<int[]> path = PathGenerator.getPathFromDirections(new int[]{2, 2}, directions);
        System.out.println();
        for (int[] coord : path) {
...
/*
    ...
    public void testPathConversion() {
        ...
        List<int[]> path = PathGenerator.getPathFromDirections(start, Arrays.asList(directions));
        ...
        List<Direction> directionsConvertedBack = PathGenerator.getDirectionsFromPath(start, path);
